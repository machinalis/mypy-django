...
from typing import Any, BinaryIO, Dict, Iterable, Iterator, Optional, overload, Pattern, Tuple, Union
...
class HttpRequest:
    ...
    upload_handlers = ... # type: List[uploadhandler.FileUploadHandler]
...
class QueryDict:
    ...
    def setlistdefault(self, key: str, default_list: List[str]=None) -> Optional[List[str]]: ...
    def appendlist(self, key: str, value: str) -> None: ...
    def pop(self, key: str, *args: Any) -> List[str]: ...
